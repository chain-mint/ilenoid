      ...
      <header className="bg-deep-blue text-white shadow-md">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div>
              <h1 className="text-2xl font-bold">Ilenoid</h1>
        ...
        <div className="mb-6 flex items-center justify-between flex-wrap gap-4">
          <div>
            ...
            <p className="text-slate-grey opacity-70">
              Discover and support transparent charity projects on Stacks
            </p>
          </div>
      ...
      <footer className="bg-slate-grey text-white mt-12 py-6">
        <div className="container mx-auto px-4 text-center">
          <p className="text-sm opacity-80">
            Built on Stacks • Transparent • Trustless • Decentralized
          </p>
        </div>
      </footer>
    </div>
